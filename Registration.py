...
l1 = tk.Label(window, text="Register Here!!", font=("Times new roman", 30, "bold"),  fg="Black")
l1.place(x=190, y=20)
...
btn = tk.Button(window, text="Sign-In", bg="green",font=("",20),fg="white", width=9, height=1, command=insert)
