...
title=tk.Label(root, text="Log in to System", font=("Times new roman", 30, "bold"),bd=3,fg="blue")
title.place(x=550,y=130,width=300)        
...
btn_log=tk.Button(Login_frame,text="Login",command=login,width=15,font=("Times new roman", 14, "bold"),bg="blue",fg="white",borderwidth = 0)
